...
class _HomeFormState extends State<HomeForm> {
  ...
  Future<void> getUserData() async {
    ...
    setState(() {
      ...
      _conFirstName.text = sp.getString("first_name")!;
      _conLastName.text = sp.getString("last_name")!;
  ...
  update() async {
    ...
    String fname = _conFirstName.text;
    String lname = _conLastName.text;
    ...
    if (_formKey.currentState!.validate()) {
      ...
      UserModal user = UserModal(uid, fname, lname, email, passwd);
  ...
  Future updateSP(UserModal? user, bool add) async {
    final SharedPreferences sp = await _pref;
